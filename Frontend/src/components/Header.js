...
//                         Inventory and Employee Management System for Velavan Textile Company
//                         </span>
//                       </div>
//                     </div>
//                   </div>
...
const userNavigation = [
  { name: "View Logins", href: "/view-logins" }, // New button for viewing logins
                          ...
                          {userNavigation.map((item) => (
                            <Menu.Item key={item.name}>
                              {({ active }) => (
                                ...
                                >
                                  <span onClick={() => item.name === "Sign out" && authContext.signout()}>
                                    {item.name}{" "}
                                  </span>
                                </Link>
                              )}
